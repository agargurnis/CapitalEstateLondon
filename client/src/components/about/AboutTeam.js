			...
			<div>
				<div className="kaka">
					<h3 className="text-center my-5 about-why-title">
						<FormattedMessage
							id="about.why"
							defaultMessage="Why Capital Estate London?"
						/>
					</h3>
						...
						<div className="col-sm-12 col-md-8 text-lg-left text-center ">
							<div className="about-why-bubble sb6">
								...
								<p>
									...
									<FormattedMessage
										id="about.whyBubble1"
										defaultMessage="We are a professional company that knows its business.
									...
									<FormattedMessage
										id="about.whyBubble2"
										defaultMessage="Our strongest advantage over other seemingly similar
									...
									<FormattedMessage
										id="about.whyBubble3"
										defaultMessage="Another, no less important argument in favor of
